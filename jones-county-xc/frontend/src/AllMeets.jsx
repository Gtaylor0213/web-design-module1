...
function AllMeets() {
  ...
  if (!meets || meets.length === 0) return <p className="text-gray-500 mt-8 text-center">No meets found.</p>
        ...
        {meets.map((meet) => {
          ...
          return (
            <button
              ...
              className={`bg-white border rounded-xl p-5 text-left hover:shadow-lg hover:scale-[1.01] transition-all cursor-pointer ${
                isPast
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-bold text-gray-900">{meet.Name}</h3>
                {isPast && (
              ...
              <p className="text-sm text-gray-600 flex items-center gap-1.5">
                ...
                {meetDate.toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
              </p>
