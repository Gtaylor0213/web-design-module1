      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {meets.map((meet) => (
          <button
            ...
            className="bg-white shadow rounded-lg p-5 text-left hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer"
          >
            <h3 className="font-bold text-gray-800 mb-2">{meet.name}</h3>
